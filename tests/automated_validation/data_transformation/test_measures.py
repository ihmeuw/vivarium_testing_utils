...
def test_incidence(
    ...
    assert measure.artifact_like_datasets == {"data": measure.measure_key}
...
def test_categorical_relative_risk(
    ...
    assert measure.artifact_like_datasets == {
    ...
    artifact_data = measure.get_measure_data_from_artifact_gbd(
